...
export let MTR = "0xfAC315d105E5A7fe2174B3EB1f95C257A9A5e271";
export let MTRG = "0x8a419ef4941355476cf04933e90bf3bbf2f73814";
...
export function getTokenDecimals(token: string): u8 {
  ...
  tokenDecimals.set(MTR, 18);
  tokenDecimals.set(MTRG, 18);
...
export function getTokenAmountUsd(token: string, amount: BigInt): BigInt {
  ...
  let denominator = BigInt.fromI32(10).pow(18);
...
export function getTokenPrice(token: string): BigInt {
  if (token == GMX) {
    ...
    if (uniswapPriceEntity != null) {
      ...
      return BigInt.fromI32(1).pow(18);
    }
  } else {
    ...
    if (chainlinkPriceEntity != null) {
      ...
      return chainlinkPriceEntity.value.times(BigInt.fromI32(10).pow(12));
    } else {
      return BigInt.fromI32(1).pow(18);
    }
  }
